...
// TheOneWhoKnocks
// 05/01/2019
// This script will spawn a Flamer when the trigger object is found
// Many thanks to the man himself, Alias, whose hard work and creativity made these scripts possible and thankfully he was willing to share them with the community
/*
// by ALIAS
