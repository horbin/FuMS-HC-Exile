// BanditCamp-Strigoi.sqf
// TheOneWhoKnocks
// 5/12/19
// Based upon drsubo Mission Scripts
// Base script used to launch random anomolies

[
	["BanditCamp-Strigoi", 200, "LAND",[0,0,0],"MissionFXStart","MissionFXEnd"], // Mission Title NOSPACES!, and encounter radius
	...
	[//BUILDINGS: persist = 0: building deleted at event completion, 1= building remains until server reset.
		...
		["Land_Grave_rocks_f",		[((round random 50)-25),((round random 50)-25)],	(round random 360),		0],  //type, offset, rotation, presist flag
