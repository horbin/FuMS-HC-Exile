...
// TheOneWhoKnocks
// 5/12/19
// Random "trap" style events spawn around the map that trigger various "entities" using ALIAS's Anomoly scripts.  These are freakin' awesome
// I've made them relatively easy to kill so they're just spawn events for players, but this will give you an understanding on how to use them
