// BanditCamp-Flamer.sqf
// TheOneWhoKnocks
// 5/12/19
// Based upon drsubo Mission Scripts
// Spawns a minor camp but with an anomoly (Flamer)

[
	["BanditCamp-Flamer", 200, "LAND",[0,0,0],"MissionFXStart","MissionFXEnd"], // Mission Title NOSPACES!, and encounter radius
