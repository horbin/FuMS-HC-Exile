...
// 	TheOneWhoKnocks
// 	02/02/2020
// 	Dynamic mission to spawn guerilla type AI around basic missions
...
[
	["SpawnScavengers", 300], 	// Mission Title NOSPACES!, and encounter radius.  This example has no options
	["SpawnScavengers","hd_objective","ELLIPSE","ColorKhaki","DiagGrid",300],    // Map Markers ["MapText", "SHAPE", "COLOR", "FILL", size];
	[  
		...
		[
			"SpawnScavengers Launching",	// The first line is the title of the pop-up box
			"Launching SpawnScavengers mission"		// The second line is the actual text in the box
		],
