// EvacTownAir.sqf
// Helicopter extraction of any troops in the area.
// TheOneWhoKnocks
// 7/21/19
// Based upon drsubo and Horbin mission scripts

[
	["EvacTownAir", 200], // Mission Title NOSPACES!, and encounter radius
	["EvacAir","mil_objective","ELLIPSE","ColorRed","FDiagonal",200],    // Map Markers ["MapText", "SHAPE", "COLOR", "FILL", size];
	...
	[  
		...
		[
			"Air assets inbound!",
			"The rescue team is inbound and will arrive soon to extract their guys.  Get there fast!"
		],
	...
	[
		[  // Convoy #1    South
			[         // Vehicle                                 Offset     Crew (only 1 type!)   CargoLoot (see Loot section below for more detail!)
				[  ImFX_Heli_Transport,[0,2000],[1,"Paratrooper"],        "TruckJunk"      ] 
			],
			[	// Drivers                               # and type  |       Patrol |   spawn  | dest | 'Patrol' options
				[["EAST","COMBAT","RED","COLUMN"],   [  [1, "Pilot_E"]  ],   ["AirEvac",[0,2000],[0,0],["FULL",500,true, true]   ]]
			],
			[   
