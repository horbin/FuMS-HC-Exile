...
[
	...
	["Bandit Camp","plp_mark_as_tent", "ELLIPSE","ColorGreen","FDiagonal",200],    // Map Markers ["MapText", "SHAPE", "COLOR", "FILL", size];
	...
	[//BUILDINGS: persist = 0: building deleted at event completion, 1= building remains until server reset.
		[ImFX_Build_Mil_Tower,[((round random 20)-10),((round random 20)-10)],0,0]   //type, offset, rotation, presist flag
	],
	[ // AI GROUPS. Only options marked 'Def:' implemented.
		//[["EAST","STEALTH","RED","LINE"],	[  [1,"Sniper_I"]	],   ["LOITER",	[((round random 50)-100),((round random 50)-100)],	[6,6],[5,"ANY"]	]],
