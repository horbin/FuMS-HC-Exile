...
// 4/20/19
// This will spawn the missions specific to Namalsk and have been ported over from DMS add on missions 
//
...
[
    [  											// *******Options*********
        "Namalsk", 								// Needs to match the folder name!
