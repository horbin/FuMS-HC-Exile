...
[
	...
	["Offroad Vehicle","plp_mark_as_vehicletraining","ELLIPSE","ColorKhaki","DiagGrid",300],    // Map Markers ["MapText", "SHAPE", "COLOR", "FILL", size];
	[  
	...
	[	
		...
		[CAMS_Land_Offroad_C,				[17.2,0],				0,			[.5,   1,     .5,         .5,         .5]]
