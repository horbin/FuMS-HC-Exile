...
[
	...
	["Huey Steal","plp_mark_civ_helicopter","ELLIPSE","ColorKhaki","DiagGrid",300],    // Map Markers ["MapText", "SHAPE", "COLOR", "FILL", size];
	[  
	...
	[	
		...
		[ImFX_Exile_Heli_UnarmedHueys, 	[15,15],	(round random 360),	[.5,   1,     .5,         .5,         .5]]
