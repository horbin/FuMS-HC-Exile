// 	FuMS_nedural_mission.sqf
// 	TheOneWhoKnocks
// 	4/20/19
// 	Dynamic mission to spawn a Ural with guards
...
[
	...
	[  
		...
		[
			"Ural Picnic",	// The first line is the title of the pop-up box
			"Bandits with a Ural have stopped for lunch. Go kill the bandits and steal the truck"		// The second line is the actual text in the box
		],
		
		// Mission Success Message
		[
			"Ural stolen",
			"Convicts killed everyone and made off with the Ural"
		],
	  
		// Mission Failure Message
		[
			"Ural driven off",
			"The attackers finished eating and drove off."
		] 
	],
	...
	[	
		...
		[ImFX_Mil_Ural_ALL,						[5,0],				0,			[.5,   1,     .5,         .5,         .5]]
