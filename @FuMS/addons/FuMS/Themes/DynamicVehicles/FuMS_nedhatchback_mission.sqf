...
[
	...
	["Hatchback Vehicle","plp_mark_civ_carDealer","ELLIPSE","ColorKhaki","DiagGrid",300],    // Map Markers ["MapText", "SHAPE", "COLOR", "FILL", size];
	[  
	...
	[	
		...
		[ImFX_Exile_Land_Hatchbacks_ALL,				[-10,-10],				0,			[.5,   1,     .5,         .5,         .5]]
