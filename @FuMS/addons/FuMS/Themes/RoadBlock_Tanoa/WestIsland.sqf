...
//--Map Marker Config.
    "Free Shrooms",  // Name, set to "" for nothing
     "ExileMagicMushroomsIcon", // icon type:                                     https://community.bistudio.com/wiki/cfgMarkers for other options.
...
[
 //  ["Random",[0,0]],["Random",[5,5]],["Random",[-5,5]]
   ...
   // AND don't forget you can use these loot options to fill vehicles with loot too!(see vehicle section below)
    ...
    "RoadBlock" ,        // WIN Loot
    [5,5]                // Offset from mission center x,y, 3 coords [x,y,z] places loot at a specific map location!  
],[
    "None" ,            // Lose Loot.
