// 	FuMS_nedresearch_mission.sqf
// 	TheOneWhoKnocks
// 	4/20/19
// 	Dynamic mission to spawn a research camp with guards
...
[
	...
	["Research Camp","plp_mark_as_goggles","ELLIPSE","ColorBlue","Cross",300],    // Map Markers ["MapText", "SHAPE", "COLOR", "FILL", size];
	[  
		...
		[
			"Research Camp",	// The first line is the title of the pop-up box
			"A research camp with bandits has been spotted, find out what they are up to"		// The second line is the actual text in the box
		],
		
		// Mission Success Message
		[
			"Research Camp cleared",
			"Convicts have taken over the research camp"
		],
	  
		// Mission Failure Message
		[
			"Research Camp abandoned",
			"The research camp has packed up and left with whatever they were making"
		] 
	],
	[  	//  Loot Config:  Refer to LootData.sqf for specifics																		

		["None" , 			[5,5] ], //[static loot, offset location] - spawns with the mission
		["ResearchLoot" ,	[5,5] ], // Win loot, offset location - spawns after mission success
	...
	[	
		...
		[CAMS_Land_Transport_ALL_I,		[17.2,0],				(round random 360),			[.5,   1,     .5,         .5,         .5]],
		...
		["Land_CncBarrierMedium4_F",[1,-7],0,0],
		["Land_CncBarrierMedium4_F",[-3,-4],90,0],
		["Land_CncBarrierMedium4_F",[-3,3.5],90,0]		
	...
	[			// Vehicles	
		[  		// Static Guns  		
			[   // Vehicle                     Offset     				Direction   CargoLoot (see Loot section below for more detail!)
				...
				[  "O_HMG_01_high_F",		[-7,4],						[(round random 360)],     	"None" ] 
