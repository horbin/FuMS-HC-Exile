...
[
	["divers", 100,"WATER"], // Mission Title NOSPACES!, and encounter radius
	["divers","c_ship","ELLIPSE","ColorBlue","FDiagonal",200],    // Map Markers ["MapText", "SHAPE", "COLOR", "FILL", size];
	...
	[
		"Diver Patrol",
		"Wait, is that someone else in the water..."
	],
		
		// Mission Success Message
	[
		"Mission Success",
		"The diver patrol was destroyed"
	],
