...
[
	["neutrals", 100,"LAND"], // Mission Title NOSPACES!, and encounter radius
	["neutrals","c_ship","ELLIPSE","ColorBlue","FDiagonal",200],    // Map Markers ["MapText", "SHAPE", "COLOR", "FILL", size];
	...
	[
		"CAUTION",
		"Some tourists have been seen in the area!"
	],
	...
	[ // AI GROUPS. Only options marked 'Def:' implemented.
		...
		[["RESISTANCE","COMBAT","RED","LINE"],   [  [3,"CivCombat"]           ],     ["BoxPatrol",[0,0],[0,0],[25]     ]],
		[["RESISTANCE","COMBAT","RED","LINE"],   [  [3,"CivNoGun"]           ],     ["BoxPatrol",[0,0],[0,0],[25]     ]]
	...
	[
		[
			...
			["LUCNT",["LowUnitCount","GUER",0,0,[0,0]]  ]
