...
// Updated 9/28/18 by TheOneWhoKnocks (Fixed layout, added messages)

[
	["smallband", 100, "LAND"], // Mission Title NOSPACES!, and encounter radius
	["smallband","mil_objective", "ELLIPSE","ColorGreen","FDiagonal",200],    // Map Markers ["MapText", "SHAPE", "COLOR", "FILL", size];
	...
	[ // AI GROUPS. Only options marked 'Def:' implemented.
		...
		[["EAST","COMBAT","RED","LINE"],   [  [3,"Rifleman_E"]           ],   ["Explore",[((floor random 100)-50),((floor random 100)-50)],[0,0],[50]     ]]
	],
