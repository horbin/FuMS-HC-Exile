...
[
	["LootCrateW", 50, "LAND"], // Mission Title NOSPACES!, and encounter radius
	["Loot Crate - W","hd_start","ELLIPSE","ColorWhite","FDiagonal",25],    // Map Markers ["MapText", "SHAPE", "COLOR", "FILL", size];
	[  
	...
	// Loot for this mission is contained in the Vehicles!
		["LootcrateW" , [-10,10] ], //[static loot, offset location] - spawns with the mission
	...
	[//BUILDINGS: persist = 0: building deleted at event completion, 1= building remains until server reset.
		[CAMS_Wreck_Land,	[2,3], (random 360), 0, "Fire_Big" ]
