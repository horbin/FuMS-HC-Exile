...
[
	["LootCrateI", 5, "LAND"], // Mission Title NOSPACES!, and encounter radius
	["","plp_icon_container","ELLIPSE","ColorWhite","FDiagonal",5],    // Map Markers ["MapText", "SHAPE", "COLOR", "FILL", size];
	[  
