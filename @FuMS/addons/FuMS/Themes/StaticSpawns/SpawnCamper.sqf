...
[
	["SpawnCamper", 50, "LAND"], // Mission Title NOSPACES!, and encounter radius
	["SpawnCamper","mil_dot","ELLIPSE","ColorYellow","FDiagonal",25],    // Map Markers ["MapText", "SHAPE", "COLOR", "FILL", size];
	[  
	...
	[ // AI GROUPS. Only options marked 'Def:' implemented.
		[["EAST","STEALTH","RED","COLUMN"],   [  [2,"Survivor"]  ],   ["Explore",[((round random 400)-200),((round random 400)-200)],[0,0],[75]   ]]
	],
