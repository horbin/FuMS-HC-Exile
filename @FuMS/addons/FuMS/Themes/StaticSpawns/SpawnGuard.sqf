...
[
	["SpawnGuard", 50, "LAND"], // Mission Title NOSPACES!, and encounter radius
	["SpawnGuard","mil_dot","ELLIPSE","ColorYellow","FDiagonal",25],    // Map Markers ["MapText", "SHAPE", "COLOR", "FILL", size];
	[  
		[				// NOTIFICATION Messages and Map display Control.
		false, 0, 500, 	// Notify players via Radio Message, radio channel, range from encounter center (0=unlimited.
	...
	[ // AI GROUPS. Only options marked 'Def:' implemented.
		[["EAST","STEALTH","RED","COLUMN"],   [  [2,"Survivor"]  ],   ["Explore",[((round random 150)-75),((round random 150)-75)],[0,0],[75]   ]]
	],
