...
[
	["LootCrate", 300, "LAND"], // Mission Title NOSPACES!, and encounter radius
	["Loot Crate","ExileMissionStrongholdIcon","ELLIPSE","ColorWhite","FDiagonal",25],    // Map Markers ["MapText", "SHAPE", "COLOR", "FILL", size];
	[  
	...
	// Loot for this mission is contained in the Vehicles!
		["Lootcrate" , [0,0] ], //[static loot, offset location] - spawns with the mission
	...
	[ 	// AI GROUPS. Only options marked 'Def:' implemented.
		[["RESISTANCE","STEALTH","RED","COLUMN"],   [  [1,"Rifleman"],[1,"Hunter"]  ],   ["Explore",[0,75],[0,0],[75]   ]]
	],
