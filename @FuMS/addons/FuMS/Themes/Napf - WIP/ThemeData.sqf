...
// 4/20/19
// This will spawn the missions specific to NAPF and have been ported over from DMS add on missions 
//
...
[
    [  											// *******Options*********
        "NAPF", 								// Needs to match the folder name!
