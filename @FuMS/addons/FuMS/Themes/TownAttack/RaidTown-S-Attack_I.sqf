	...
	[
		[  // Convoy #1    South
			...
			[  
				...
				[["GUER","COMBAT","BLUE","COLUMN"],   [  [1, "Driver_I"]  ],   ["Convoy",[0,-1050],[0,-50],["NORMAL",true,true, true]   ]]
			],
			[   
				// Troops : These are distributed across all vehicles in this convoy.                                                         
				//  Troop behaviour and side options                        # and type of Troops     Patrol logic |  spawn     |dest |'Patrol' options
				//[["EAST","COMBAT","RED","COLUMN"],[[1,"SMG_E"] ,[3, "Rifleman_E"]],["Buildings",[0,-1000],[0,-25],[100]]], // [timer, radius]
				[["GUER","COMBAT","RED","COLUMN"],[[1,"SMG_I"] ,[2, "Rifleman_I"]],["Explore",[0,-1050],[25,0],[100]]] // [timer, radius]
			]
		],
		[  // Convoy #2    West
			[         // Vehicle                                 Offset     Crew (only 1 type!)   CargoLoot (see Loot section below for more detail!)
			...
			[   
				// Troops : These are distributed across all vehicles in this convoy.                                                         
				//  Troop behaviour and side options                        # and type of Troops     Patrol logic |  spawn     |dest |'Patrol' options
				[["GUER","COMBAT","RED","COLUMN"],[[1,"SMG_I"] ,[2, "Rifleman_I"]],["Buildings",[-1000,0],[-10,0],[100]]] // [timer, radius]
			]
		]
	],
	[
