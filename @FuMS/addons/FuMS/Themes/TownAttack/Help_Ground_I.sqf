...
// TheOneWhoKnocks
// 02/13/2020
// Mission designed to be launched in response to a call for reinforcements. (GUER)
...
[
	["Help_Ground_I", 200,"LAND"], // Mission Title NOSPACES!, and encounter radius
	["Help Ground I","mil_dot","ELLIPSE","ColorGreen","FDiagonal",200],    // Map Markers ["MapText", "SHAPE", "COLOR", "FILL", size];
	[  
		...
		[
			...
			"Guerilla forces have called in ground reinforcements!" //description/radio message.
		],  
	...
	[ 	// AI GROUPS. Only options marked 'Def:' implemented.
		[["GUER","AWARE","RED","COLUMN"],   [  [1,"Sniper_I"],[2,"Rifleman_I"],[2,"Hunter_I"]  ],   ["BoxPatrol",[200,200],[0,0],[75]   ]]
	],
	// Vehicles
	[
