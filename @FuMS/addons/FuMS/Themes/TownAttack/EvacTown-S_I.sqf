...
// TheOneWhoKnocks
// 12/28/19
// Spawns in an GUER recovery squad to transport remaining OPFOR out of combat zone

[
	["EvacTown-S_I", 200], // Mission Title NOSPACES!, and encounter radius
	["EvacTown-S_I","mil_objective","ELLIPSE","ColorRed","FDiagonal",200],    // Map Markers ["MapText", "SHAPE", "COLOR", "FILL", size];
	...
	[  
		...
		[	// Spawn Mission Message
			"Resistance is Exfiltrating",
			"The GUER is calling in their buddies to get them out of there."
		],	
	...
	[
		[ 	// Convoy #1    West
			[ // Vehicle          Offset  | Crew (only 1 type!)   CargoLoot (see Loot section below for more detail!)
				[ CAMS_Mil_Transport_ALL_I,	[-600,0],	[1,"Rifleman_I"],        "TruckJunk"      ],
				[ CAMS_Mil_Armed_I,	[-650,0],		[1,"Rifleman_I"],        "TruckJunk"      ] 				
			],
