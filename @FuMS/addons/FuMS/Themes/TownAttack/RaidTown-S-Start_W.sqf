...
[
	["RaidTown-S-Start_W", 200], // Mission Title NOSPACES!, and encounter radius
	["RaidTown-S-Start_W","mil_objective","ELLIPSE","ColorRed","FDiagonal",200],    // Map Markers ["MapText", "SHAPE", "COLOR", "FILL", size];
	...
	[ // AI GROUPS. Only options marked 'Def:' implemented.
		[["WEST","COMBAT","RED","WEDGE"],   [  [1,"SMG_W"],	[2,"Rifleman_W"]  ],   	["Buildings",	[10,0],[0,0],[100]   ]],
		[["WEST","COMBAT","RED","VEE"],   	[  [1,"LMG_W"],	[2,"Rifleman_W"]  ],   	["Buildings",	[0,0],[10,0],[100]   ]],
		[["WEST","COMBAT","RED","WEDGE"],   [  [3,"Rifleman_W"]  ],   				["Buildings",	[0,10],[0,0],[75]   ]]
	...
	[
		[
			...
			["LowCount",	["LowUnitCount","WEST",5,0,[0,0]]  ],
			["AllDead",		["LowUnitCount","WEST",0,0,[0,0]]  ]
		...
		[
			...
			[["CHILD",["HelpHelo_W",[0,0],1,2000]],["LowCount"     ]],  // 
