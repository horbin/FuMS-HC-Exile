...
[
	...
	[
		...
		[  // Division #1
			[ // Vehicle                         Offset     Crew (only 1 type!)   CargoLoot (see Loot section below for more detail!)
				//[  CAMS_Heli_Armed_E,		[0,0],		[1,"AirCrew_E"],	"HeliJunk" ],  
				[  "B_Heli_Light_01_dynamicLoadout_F",		[0,-100],	[1,"AirCrew_E"],	"HeliJunk" ]
			],
			[  
			// Pilots                              # and type  |      Patrol  |  spawn  | dest | 'Patrol' options                                                                                                RTB, Roads, Despawn, Height
				[["EAST","COMBAT","RED","COLUMN"],   [[1, "DumbPilot_E"]],	["TrackRoute",[0,0],[0,0],["COMBAT","NORMAL",["Villages","Villages","Cities","Capitals","Villages","Villages"],false,false,false,100   ]]]
			],
			[   
				...
				//[["EAST","COMBAT","RED","COLUMN"],	[[4,"AirCrew_E"]],	["PatrolRoute",[0,0],[0,0],["COMBAT","NORMAL",["Villages"],true,false,true,100   ]]]
	...
	[
		[
			...
			["AllDead",		["LowUnitCount","EAST",0,0,[0,0]]  ]		// Always leaves one behind as a special surprise for players.
