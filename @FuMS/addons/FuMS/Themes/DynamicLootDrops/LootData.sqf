...
[
	...
	*/
	...
	[///////////////////////////////////////////////////////////////////////////
		// Loot Option title, and box to be used.  Use of array names is permitted. 
		["MedicalLoot", "C_IDAP_supplyCrate_F"],  //Box_NATO_Wps_F
		[// All weapons and quantity 
	...
	[////////////////////////////////////////////////
		// Loot Option title, and box to be used.  Use of array names is permitted. 
		["GunsLoot", "box_FIA_wps_F"],  //Box_NATO_Wps_F
		[// All weapons and quantity 
	...
	[///////////////////////////////////////////////////////////////////
		// Loot Option title, and box to be used.  Use of array names is permitted. 
		["BaseBuildingLoot", "IG_supplyCrate_F"],  //Exile_Container_SupplyBox
		[// All weapons and quantity 
			[CAMS_AssaultRifles_I, 		[3,0,1]]
		],
		[// All magazines and quantity
			["FuMS_AmmoForEach",		[2,0,2]]
		],
		[// All items and quantity
			[FuMS_Building_Supplies ,	[9,1,4]]
		],
		[// All backpacks and quantity			
			[CAMS_Packs_ALL, 			[2,0,1]]
		]
	...
	[////////////////////////////////////////////////////////////////
		// Loot Option title, and box to be used.  Use of array names is permitted. 
		["PopTabLoot", "Exile_Container_Storagecrate"],  //Box_NATO_Wps_F
		[// All weapons and quantity 
		],
		[// All magazines and quantity
		],
	...
	[
		...
		[// All weapons and quantity  
			[CAMS_AssaultRifles_I,			[1,0,3]], 
			[CAMS_Pistols_I,				[1,0,2]] 
		],
		[// All magazines and quantity
			["FuMS_AmmoForEach",			[2,0,2]]
		],
