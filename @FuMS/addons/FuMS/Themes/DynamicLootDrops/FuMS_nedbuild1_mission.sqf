// 	FuMS_nedbuild1_mission.sqf
// 	TheOneWhoKnocks
// 	4/20/19
// 	Dynamic mission to spawn a building supply pod with guards
...
/*
	Building Materials Mission with new difficulty selection system
...
[
	...
	[  
		...
		[
			"DIY Materials",	// The first line is the title of the pop-up box
			"A DIY storage is under attack! Go kill the attackers!"		// The second line is the actual text in the box
		],
		
		// Mission Success Message
		[
			"DIY materials stolen!",
			"Convicts grabbed all the building materials"
		],
	  
		// Mission Failure Message
		[
			"DIY materials looted",
			"The attackers stole everything!"
		] 
	],
	[  	//  Loot Config:  Refer to LootData.sqf for specifics																		

		["None" , 				[5,5] ], //[static loot, offset location] - spawns with the mission
		["BaseBuildingLoot" ,	[5,5] ], // Win loot, offset location - spawns after mission success
	...
	[	
		...
		[CAMS_Land_Work_C,						[-10,10],			0,			[.5,   1,     .5,         .5,         .5]],
		...
		["Land_Cargo_House_V4_F",			[-6.2,15],			0,					0],
		["Land_Cargo_House_V4_F",			[15,0],				90,					0],
		["Land_Cargo_House_V4_F",			[15,6.2],			90,					0],
		["Land_Cargo_House_V4_F",			[15,-6.2],			90,					0],
		["Land_Cargo_House_V4_F",			[0,-15],			180,				0],
		["Land_Cargo_House_V4_F",			[-6.2,-15],			180,				0],
		["Land_Cargo_House_V4_F",			[6.2,-15],			180,				0],
		["Land_Cargo_House_V4_F",			[-15,0],			270,				0],
		["Land_Cargo_House_V4_F",			[-15,-6.2],			270,				0],
		["Land_Cargo_House_V4_F",			[-15,6.2],			270,				0]
