...
// 	TheOneWhoKnocks
// 	02/02/2020
// 	Dynamic mission to spawn an offroad vehicle with guards
...
[
	["OffroadSteal", 300], 	// Mission Title NOSPACES!, and encounter radius.  This example has no options
	["Offroad Steal","plp_mark_civ_SportsRunning","ELLIPSE","ColorKhaki","DiagGrid",300],    // Map Markers ["MapText", "SHAPE", "COLOR", "FILL", size];
	[  
		...
		[
			"Offroad Vehicle",	// The first line is the title of the pop-up box
			"Bandits with an offroad have broken down. Go kill the bandits and steal their offroad"		// The second line is the actual text in the box
		],
		
		// Mission Success Message
		[
			"Offroad Vehicle captured",
			"Convicts killed everyone and made off with the offroad"
		],
	  
		// Mission Failure Message
		[
			"Offroad Vehicle gone",
	...
	[	
		...
		[CAMS_Land_Offroad_C,				[17.2,0],				(round random 360),			[.5,   1,     .5,         .5,         .5]],
	...
	[
		[
			...
			["SpawnAI",		["ProxPlayer", 	[0,0], 700, 1]],
			["OffroadStolen",	["TakeVehicle", 	"0", 50]],
			//["KillMost",		["BodyCount",6] ],
			["Timer", 			["TimerNoPlayers", 		random [1600,1800,1900]]]	//1600 - 1900 second mission timer	
		...
		[
			...
			[["CHILD",	["SpawnGuards",[0,0],1,10000]],["SpawnAI"     ]],  
			[["WIN"],	["OffroadStolen"     			]],
			[["LOSE"],	["Timer"				]],
			[["END"],	["OffroadStolen","OR","Timer"	]]  
		]
	]
];
