...
[
	...
	["Car Steal","plp_mark_civ_SportsRunning","ELLIPSE","ColorKhaki","DiagGrid",300],    // Map Markers ["MapText", "SHAPE", "COLOR", "FILL", size];
	[  
	...
	[
		[
			...
			["Timer", 		["TimerNoPlayers", 		random [1500,1700,1800]]]	// 1500 - 1800 second mission timer	
		],
		[
