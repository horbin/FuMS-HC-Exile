// 	FuMS_nedifrit_mission.sqf
// 	TheOneWhoKnocks
// 	4/20/19
// 	Dynamic mission to spawn an Ifrit vehicle with guards
...
[
	...
	[  
		...
		[
			"Ifrit Stopped",	// The first line is the title of the pop-up box
			"An Ifrit is parked at a small base! Go kill them and steal it"		// The second line is the actual text in the box
		],
		
		// Mission Success Message
		[
			"Ifrit captured",
			"Convicts killed everyone and made off with the Ifrit"
		],
	  
		// Mission Failure Message
		[
			"Ifrit gone",
			"The attackers drove off in the Ifrit and the base escaped attack."
		] 
	],
	...
	[	
		...
		["Exile_Car_Ifrit",				[-10,-10],				0,			[.5,   1,     .5,         .5,         .5]]
