// 	FuMS_nedhatchback_mission.sqf
// 	TheOneWhoKnocks
// 	4/20/19
// 	Dynamic mission to spawn a Hatchback vehicle with guards
...
/*
	Hatchback Mission with new difficulty selection system
...
[
	["HatchbackMission", 300], 	// Mission Title NOSPACES!, and encounter radius.  This example has no options
	["Hatchback Vehicle","hd_objective","ELLIPSE","ColorKhaki","DiagGrid",300],    // Map Markers ["MapText", "SHAPE", "COLOR", "FILL", size];
	[  
		...
		[
			"Hatchback Stopped",	// The first line is the title of the pop-up box
			"A Hatchback is parked at a small base! Go kill them and steal it"		// The second line is the actual text in the box
		],
		
		// Mission Success Message
		[
			"Hatchback captured",
			"Convicts killed everyone and made off with the Hatchback"
		],
	  
		// Mission Failure Message
		[
			"Hatchback gone",
			"The attackers drove off in the Hatchback and the base escaped attack."
		] 
	],
	...
	[	
		...
		[FuMS_Civ_Hatchbacks,				[-10,-10],				0,			[.5,   1,     .5,         .5,         .5]]
	...
	[ 	// AI GROUPS. Only options marked 'Def:' implemented.
		[["EAST","AWARE","RED","VEE"],   	[  [4,"Rifleman"]  ],   				["Loiter",		[2,2],[0,0],[10]   ]],
	...
	[			// Vehicles	
		...
		[
			...
			[   // Vehicle                     	Offset     				Direction   CargoLoot (see Loot section below for more detail!)  
				[  FuMS_Mil_ArmedOffroads,		[-75,75],	[1,"Rifleman"],        "TruckJunk",[0]      ]
				// If driver-less vehicles are desired, place them at the bottom of the list AND have less drivers than vehicles in the next section
				// NOTE: Troops WILL be placed into 'driver-less' vehicles if the other vehicles are full!!!
			],
			[  
