...
[
	["SpawnGang", 75], // Mission Title NOSPACES!, and encounter radius
	["SpawnGang","hd_objective","ELLIPSE","ColorOrange","FDiagonal",75],    
	...
	[ // AI GROUPS. Only options marked 'Def:' implemented.
		...
		[["EAST","COMBAT","RED","LINE"],   [  [2,"LMG_E"],[1,"Hunter_E"] ],	["EXPLORE",   [((round random 50)-100),((round random 50)-100)],[0,1], [50]	]],
		[["EAST","COMBAT","RED","LINE"],   [  [2,"Hunter_E"]           ],	["SENTRY",   [((round random 50)-100),((round random 50)-100)],[1,0], [50]	]]
	],
	 // Vehicles
	[		 
	],            
