...
[
	["veReinforcments", 200,"LAND"], // Mission Title NOSPACES!, and encounter radius
	...
	[
		[  // Convoy #1    
			...
			[         // Vehicle                                 Offset     Crew (only 1 type!)   CargoLoot (see Loot section below for more detail!)
				["O_LSV_02_unarmed_F"           ,[-250,250],[ 1, "Rifleman"          ],       "None"]   
			...
			[  
				...
				[["EAST","COMBAT","RED","COLUMN"],   [  [1, "Driver"]  ],   ["Convoy",[-250,250],[0,0],["Full",true,false,true   ]]]
			],
			[   
