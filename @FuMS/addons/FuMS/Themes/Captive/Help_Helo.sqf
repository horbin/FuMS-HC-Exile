...
[
	...
	[  
		[   								// NOTIFICATION Messages and Map display Control.
			true, "ALL", 300, 				// Notify players via Radio Message, radio channel, range from encounter center (0=unlimited.
		...
		[
			...
			"Incoming paratroopers!" //description/radio message.
		],  
	...
	[
		[  									// Division #1
			...
			[  
				...
				[["EAST","COMBAT","RED","COLUMN"],   [  [1, "Pilot_E"]  ],   ["ParaDrop",[-2000,-2000],[0,0],["Full", 100, true,true  ]   ]]
			],
			[   
