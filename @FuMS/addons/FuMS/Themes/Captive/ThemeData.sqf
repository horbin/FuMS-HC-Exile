...
[
    [  					// *******Options*********
        "Captive", 		// Needs to match the folder name!
	...
	[ 					//***** Radio Chatter *****
		[ 				// AI Radio Chatter configuration
            3, 			// radio channel used by AI - "ALL"= messages heard w/o radio (other options 0-9)
		...
		[  				// AI to Base Chatter 
			["CheckIn", "On station. <DIST> meters <DIR> of Prison <MSNNAME>."],
			["Position", "Currently at <POS>."],
			["Detected", "Armed Clones detected within perimeter of <MSNNAME>."],
