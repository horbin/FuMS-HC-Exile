...
[
	...
	["City Raid","plp_mark_civ_building","ELLIPSE","ColorRed","FDiagonal",200],    // Map Markers ["MapText", "SHAPE", "COLOR", "FILL", size];
	...
	[
		[  // Convoy #1    South
			...
			[  
				...
				[["EAST","COMBAT","BLUE","COLUMN"],   [  [2, "Driver_E"]  ],   ["Convoy",[0,-1000],[0,-50],["NORMAL",true,true, true]   ]]
			],
			[   
