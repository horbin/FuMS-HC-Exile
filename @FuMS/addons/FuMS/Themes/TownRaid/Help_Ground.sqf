// grReinforcements.sqf
// TheOneWhoKnocks
// 12/27/19
// Mission designed to be launched in response to a call for reinforcements.
// Sends in 1 sniper, 2 riflemen, and 2 hunters
// These troops are ground based and spawn 300 meters to the North, with a final destination of 0,0
// No triggers and no loot for this mission, just Troops!
// Be cautious when editing data.

[
	["grReinforcments", 200,"LAND"], // Mission Title NOSPACES!, and encounter radius
	...
	[  
		...
		[
			...
			"The gang members have called in their homies!" //description/radio message.
		],  
	...
	[ 	// AI GROUPS. Only options marked 'Def:' implemented.
		[["EAST","AWARE","RED","COLUMN"],   [  [1,"Sniper_E"],[2,"Rifleman_E"],[2,"Hunter_E"]  ],   ["BoxPatrol",[400,400],[0,0],[75]   ]]
	],
	// Vehicles
	[
