...
[
	...
	// NOTE: Thid was lowered until I can fix the FPS monitor which currently reads too low.
    ],
    [  // Exclusion Areas
	...
	// Future updates may include ability to launch HC on single named instance as opposed to all HC's
