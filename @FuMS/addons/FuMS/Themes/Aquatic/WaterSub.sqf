...
[
	["WaterSubMission", 100,"WATER"], 										// Mission Title NOSPACES!, and encounter radius
	["Sub Wreck","c_ship","ELLIPSE","ColorBlue","FDiagonal",200],    	// Map Markers ["MapText", "SHAPE", "COLOR", "FILL", size];
	...
	[  																//  Loot Config:  Refer to LootData.sqf for specifcs
		...
		["RANDOM" , [10,10] ], 										// Win loot, offset location - spawns after mission success
	...
	[      
		[  															// Convoy #1    
			...
			[         												// Vehicle                                 Offset     Crew (only 1 type!)   CargoLoot (see Loot section below for more detail!)
				[  CAMS_H20_SDV_I,                    [0,10],[5,"Diver_E"],        "TruckJunk"      ]
			...
			[  
				...
				[["EAST","COMBAT","RED","COLUMN"],   [  [1, "Diver_E"]  ],   ["BoxPatrol",[0,0],[0,0],[100]   ]]
			],
			[   
