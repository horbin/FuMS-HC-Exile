// WestIsland.sqf
// TheOneWhoKnocks
// Originally created as "Dump.sqf" from Horbin
...
[	
	[
		//------------------------------------------------------------------------------------
		//-----Mission Area Setup-----
		"WestIslandRoadblock",  // Mission Title NOSPACES!
	...
	[
		...
		*/
		...
		[["EAST","COMBAT","RED","LINE"],	[[4,"Rifleman_E"]],	["Buildings",[-20,0],[-20,0],[50] ]], // 3 rifleman that will patrol all buildings within 70m for unlimited duration
		...
		[["EAST","COMBAT","RED","LINE"],	[[5,"Rifleman_E"]],	["BoxPatrol",	[-40,0],	[-40,0],	[70] ]],
		[["EAST","COMBAT","RED","LINE"],	[[3,"Sniper_E"]],	["TowerGuard",	[0,0], 		[0,0],		[150,"Land_Cargo_Patrol_V3_F"] ]]
