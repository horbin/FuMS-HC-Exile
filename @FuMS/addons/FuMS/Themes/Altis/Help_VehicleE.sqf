...
// No triggers and no loot for this mission, just Troops in an unarmed drop off vehicle!
// Units will spawn 250m to the east and proceed to within 75mn of the encounter and patrol!
// This script specifically spawns in the mission from the EAST
// Be cautious when editing data.
[
	["VicReinforcments", 200,"LAND"], // Mission Title NOSPACES!, and encounter radius
	...
	[  
		...
		[
			...
			"You hear over the radio that there is a troop transport with reinforcements on the way!" 		//description/radio message.
		],  
	...
	[
		[  // Convoy #1    
			...
			[   
				...
				[["EAST","COMBAT","RED","COLUMN"],[[1,"Sniper_E"],[3,"Rifleman_E"]],["BoxPatrol",[0,0],[0,0],[50]]]
